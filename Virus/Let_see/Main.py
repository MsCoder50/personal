...
from DB.credentials import username, password, db, Rhost
from DB.encode_decode import Decode
...
img = customtkinter.CTkImage(Image.open("Assets/logo.jpg"),size =(70,70))
