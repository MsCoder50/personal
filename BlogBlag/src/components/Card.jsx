  ...
  return (
    <div className="blogs mb-4">
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          {/* Adjusted image size to fit within card dimensions */}
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{content.slice(0, 50)}...</p>
